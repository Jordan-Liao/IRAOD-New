"""Strict source-free SARCLIP-CGA + VLST (method F).

Label-level CGA ON and an independent frozen base SARCLIP VLST encoder ON.
"""
...
work_dir = './work_dirs/vlst_cga_strict_${corrupt}'
